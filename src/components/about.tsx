...
export function About() {
  return (
    <section id="about" className="border-b border-border bg-surface px-6 py-24 sm:px-10">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <motion.div
          ...
          variants={fadeUp}
        >
          <p className="font-mono text-xs uppercase tracking-[0.2em] text-accent">01 / About</p>
          ...
          <p className="mt-5 max-w-md leading-relaxed text-muted">
            ...
            leading a small team through Agile sprints to deliver live
            websites for SME clients — from wellness e-commerce to tourism
            and travel.
          </p>
        ...
        >
          <div className="flex items-center gap-1.5 border-b border-border bg-tab-bar px-4 py-2.5">
            ...
            <span className="ml-3 font-mono text-[11px] text-muted">about.ts</span>
          </div>
          <pre className="overflow-x-auto p-6 font-mono text-[13px] leading-relaxed sm:text-sm">
            <code>
              ...
              {"\n"}
              {"  "}name: <span className="text-accent">&quot;Ahnaf Thowfeek&quot;</span>,{"\n"}
              {"  "}role: <span className="text-accent">&quot;Full Stack Developer&quot;</span>,{"\n"}
              {"  "}location: <span className="text-accent">&quot;Colombo, Sri Lanka&quot;</span>,{"\n"}
              {"  "}languages: [<span className="text-accent">&quot;English&quot;</span>,{" "}
              ...
              {"  "}focus: [<span className="text-accent">&quot;e-commerce&quot;</span>,{" "}
              <span className="text-accent">&quot;booking systems&quot;</span>,{" "}
              <span className="text-accent">&quot;tourism sites&quot;</span>],{"\n"}
